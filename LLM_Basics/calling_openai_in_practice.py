  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "5. **Copy the key immediately** — it looks like `sk-proj-abc123...xyz`. ⚠️ You'll **never** see it again. If you lose it, you have to make a new one.\n",
        "6. (Important) Go to **Billing → Add payment method** and load at least **$5** of credit. OpenAI's API is *not* free — even GPT-4o costs cents per call. The free trial credits are mostly gone these days.\n",
        "\n",
        "### Cost reality check\n",
        "\n",
        "| Model | Approx. cost |\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "1. The **URL** → `https://api.groq.com/openai/v1/chat/completions`\n",
        "2. The **model** → `llama-3.3-70b-versatile` (a free open-source model)\n",
        "\n",
